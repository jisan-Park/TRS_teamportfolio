...
{
	IMAGEMANAGER->addImage("기둥1", "image/기둥1.bmp", 120, 125, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("기둥2", "image/기둥2.bmp", 120, 125, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("우물", "image/우물.bmp", 120, 195, true, RGB(255, 0, 255));


	fence1 = new imgObj;
	fence2 = new imgObj;
	fence1->init("기둥1", 5429, 493);
	fence2->init("기둥2", 7080, 493);
	imgObj* well;
	well = new imgObj;
	well->init("우물", 6015, 489);
	_ds = new downSlope;
	_us = new upSlope;
